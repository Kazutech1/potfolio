    ...
    <section className="py-20 bg-gradient-to-b from-black to-red-950">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <img
              src="https://cryptowealth.onrender.com/your-image.jpg" // Replace with your actual image URL
              alt="Crypto Wealth"
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-end">
              <div
                className={`transform transition-all duration-300 ${
                  hoveredProject === 0 ? 'translate-y-0' : 'translate-y-12'
                }`}
              >
                <h3 className="text-red-500 text-2xl font-bold mb-2">Crypto Wealth</h3>
                ...
                <a
                  href="https://cryptowealth.onrender.com/"
                  className="inline-flex items-center text-red-600 hover:text-red-400"
                >
          ...
          >
            <img
              src="https://via.placeholder.com/600x400.png?text=VeltoHQ+ERP" // Placeholder image
              alt="VeltoHQ ERP"
              className="w-full h-64 object-cover opacity-70 group-hover:opacity-40 transition-all duration-300"
            />
            <div className="absolute inset-0 p-6 flex flex-col justify-end">
              <div
                className={`transform transition-all duration-300 ${
                  hoveredProject === 1 ? 'translate-y-0' : 'translate-y-12'
                }`}
              >
                <h3 className="text-red-600 text-2xl font-bold mb-2">VeltoHQ ERP</h3>
                <p className="text-red-600 mb-4">A lightweight ERP solution for businesses</p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-red-900/50 px-3 py-1 text-sm rounded-full">React</span>
                  <span className="bg-red-900/50 px-3 py-1 text-sm rounded-full">Node.js</span>
                  <span className="bg-red-900/50 px-3 py-1 text-sm rounded-full">MongoDB</span>
